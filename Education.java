...
public class Education
{
 ...
 char gender;
 double feestructure,admissionfee,otherfee;
 public Education(){
 }
 public Education(String usn,String name,String address,String emailid,String branch,char gender,double feestructure,double admissionfee,double otherfee)
 {
   this.usn=usn;
   this.name=name;
